      ...
      <div className="min-h-screen bg-slate-900">
        ...
        <main className="relative z-10 py-16 lg:py-24">
          <div className="container max-w-6xl mx-auto">
            ...
            <Skeleton className="w-full h-96 rounded-xl mb-8 bg-white/10" />
      ...
      <div className="min-h-screen bg-slate-900">
        ...
        <main className="relative z-10 py-16 lg:py-24">
          <div className="container max-w-4xl mx-auto text-center">
            <div className="floating-card border-red-500/30">
              <i className="fas fa-exclamation-triangle text-red-400 text-4xl mb-4"></i>
              <h1 className="text-2xl font-bold text-white mb-2">포트폴리오를 찾을 수 없습니다</h1>
              <p className="text-white/70 mb-6">요청하신 포트폴리오가 존재하지 않거나 삭제되었습니다.</p>
              <Link 
                href="/portfolio"
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="floating-card overflow-hidden">
            ...
            <div className="p-8 lg:p-12 border-b border-white/10">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight" data-testid="text-portfolio-title">
                {content.title}
              </h1>
              
              <p className="text-xl text-white/80 leading-relaxed" data-testid="text-portfolio-summary">
                {content.summary}
              </p>
            </div>
              ...
              <div className="grid lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2">
                  <div className="prose prose-lg max-w-none">
                    <h2 className="text-2xl font-bold text-white mb-6">프로젝트 상세</h2>
                    ...
                    {images.length > 0 && (
                      <div className="mt-12">
                        <h3 className="text-xl font-bold text-white mb-6">프로젝트 스크린샷</h3>
                ...
                <div className="lg:col-span-1">
                  <div className="service-card sticky top-8">
                    <h3 className="text-xl font-bold text-white mb-6">주요 성과</h3>
                      ...
                      {Object.keys(metrics).length === 0 && (
                        <>
                          ...
                          <div className="text-center">
                            ...
                            <div className="text-sm text-white/60 uppercase tracking-wide">CPA 감소</div>
                          </div>
                        </>
                      )}
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10">
                      <h4 className="font-semibold text-white mb-4">프로젝트 정보</h4>
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                          <span className="text-white/60">카테고리</span>
                          <span className="font-medium text-white">{portfolio.category}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          <span className="text-white/60">프로젝트 예상 기간</span>
                          <span className="font-medium text-white">3-6개월</span>
                        </div>
                      </div>
                    </div>
                  </div>
